...
- `20260702200039_create_appearance_settings`
- `20260704015324_create_calendar_exceptions`
...
- `20260702_appearance_settings.sql`
- `20260703_calendar_exceptions.sql`
...
No se reordena ni se repara el historial en esta implementacion. Para los SDD de configuracion se agregaron y aplicaron las migraciones nuevas `create_business_hours`, `create_appointment_settings`, `create_appearance_settings` y `create_calendar_exceptions`.
